...
$(document).on("click", ".note-parent p input.note-edit", function() {
  ...
  $(this).parent().html('<form class="editForm"><input type="submit" class="note-edit-enter btn" value=">"><input class="noteEdit noteEdit' + thisID + '" autofocus placeholder="Type to submit your note edit."></form>')
    .submit(function() {

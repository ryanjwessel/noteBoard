...
$(document).ready(function() {
  ...
  for(i = 0; i < localStorage.length; i++) {
    $(".note-container").prepend('<div class="row note-wrap" id="note-wrap-'+i+'"><div class="row note"><div class="col-xs-12 col-md-10 col-md-offset-1 note-parent"><p class="notes note-text" id="notes-'+i+'"><input type="button" class="note-delete btn" id="note-delete-'+i+'" value="X"></input><input type="button" class="note-edit btn" id="note-edit-'+i+'" value="E"></input><span class="note-content-text" style="color:#616161" onclick="noteEdit();">'+localStorage.getItem("notes-"+i)+'</span></p></div></div></div>');
  };
});

...
$(document).ready(function() {
  ...
  for(i = 0; i < localStorage.length; i++) {
    $(".note-container").prepend('<div class="row note-wrap" id="note-wrap-'+i+'"><div class="row note notes note-text note-parent" id="notes-'+i+'"><div class="col-xs-3 col-md-1 col-md-offset-1"><input type="button" class="note-delete btn" id="note-delete-'+i+'" value="X"></input><input type="button" class="note-edit btn" id="note-edit-'+i+'" value="E"></input></div><div class="col-xs-9 col-md-9"><span class="note-content-text">'+localStorage.getItem("notes-"+i)+'</span></div></div></div>');
  };
});
...
// Remove a note
$(document).on("click", ".note-parent input.note-delete", function() {
...
// Edit a note
$(document).on("click", ".note-parent input.note-edit", function() {
